...
API_KEY = "f665628641msh9930d4b1427bb07p1c6a6fjsn2963333182d5"
...
# # OpenAI API Key
# openai.api_key = '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'  # Replace with your OpenAI API key
...
#             # Weather API data processing
#             # ... (rest of the code remains unchanged)

#             # GPT-3 Chatbot Interaction
#             user_input = q  # Pass the location as input to the chatbot
#             response = chat_with_gpt(user_input)
#             return render_template('home.html', weather_data=weather_data, chatbot_response=response)
